...
const Sidebar = ({ isCollapsed, setIsCollapsed, isMobile = false }) => {
    ...
    const menuItems = [
        ...
        { icon: "menu_book", label: "MOMS", path: "/moms" },
        { icon: 'account_tree', label: 'Projects Management', path: '/projects' },
        { icon: 'shop', label: 'Vendor', path: '/vendor' },
        { icon: "wallet", label: "Expense", path: "/expense" },
